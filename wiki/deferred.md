...
|-------|------------|-----------|
| awk 17 BusyBox failures | Upstream goawk v1.31.0 engine limitations (see [todos.md](todos.md) for details). | Would require forking goawk. Core POSIX awk semantics are correct. |
