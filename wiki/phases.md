...
| [14_xml_output.md](14_xml_output.md) | XML Output Support — `--xml` flag for all 52 utilities | **PLANNING** |
| [14a_json_gap_fill.md](14a_json_gap_fill.md) | JSON/XML Gap Fill — 8 utilities missing `--json` | **PLANNING** |
