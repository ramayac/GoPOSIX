...
A Go-native, single-binary POSIX userland with 100+ tools. Runs as a persistent JSON-RPC daemon or multicall CLI, a typed Go SDK and >97.1% BusyBox test compatibility (679/699 tests pass).
