...
A Go-native, single-binary POSIX userland with 115 tools. Runs as a persistent JSON-RPC daemon or multicall CLI, a typed Go SDK and ~88% BusyBox test compatibility (808 of 919 tests pass).
...
- [Test Coverage & Compliance Matrix](wiki/test_coverage_matrix.md) — 808/919 (88.0%) BusyBox pass rate
