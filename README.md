...
A Go-native, single-binary POSIX userland with 115 tools. Runs as a persistent JSON-RPC daemon or multicall CLI, a typed Go SDK and >88% BusyBox test compatibility (810 of 919 tests pass).
...
- [Test Coverage & Compliance Matrix](wiki/test_coverage_matrix.md) — 810/919 (88.1%) BusyBox pass rate
